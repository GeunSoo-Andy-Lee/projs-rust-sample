...
//! Generated file from `segment.proto`
...
// @@protoc_insertion_point(message:sample.test.Segment)
pub struct Segment {
    // special fields
    // @@protoc_insertion_point(special_field:sample.test.Segment.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\rsegment.proto\x12\x0bsample.test\"\t\n\x07Segmentb\x06proto3\
";
